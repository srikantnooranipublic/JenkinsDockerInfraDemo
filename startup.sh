...
LOG ""
LOG ""
LOG "**** Linux Users (Jenkins etc deployed on Linux) ****"
LOG "add the following mapping to your /etc/hosts file where your browser is"
LOG "<Jenkins_Host_IP> jenkinsDockerServer"
LOG ""
LOG "Jenkins: http://jenkinsDockerServer:8080/job/DevOpsFromGit/  -- username/passwd admin/CAdemo123#"
LOG "APM ATC: http://jenkinsDockerServer:9999/ApmServer -- username/passwd  admin/"
LOG "APM WV: http://jenkinsDockerServer:9999/#investigator -- username/passwd  admin/"

LOG "***********************************************"
LOG ""
LOG "**** MAC Users (Jenkins etc deployed on MAC) ****"
LOG "add the following mapping to your /etc/hosts "
LOG "127.0.0.1 jenkinsDockerServer"
LOG ""
LOG "Jenkins: http://localhost:8080/job/DevOpsFromGit/  -- username/passwd admin/CAdemo123#"
LOG "APM ATC: http://127.0.0.1:9999/ApmServer -- username/passwd  admin/"
LOG "APM WV: http://127.0.0.1:9999/#investigator -- username/passwd  admin/"
